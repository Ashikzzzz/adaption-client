...
import loginAnimataion from "../assets/Animation/93385-login.json"
        ...
        <div className='flex items-center '>
             ...
             <div className='grid grid-cols-1'>
              <div className='mt-8'>
                ...
                <input type="text" name='confirnPassword' placeholder="Confirm Password" className="input input-bordered input-primary w-full max-w-xs " />
                </div>
                <div className='mt-1'>
                <label className="label">
              ...
              <p className='font-normal text-sm mt-1'> Already Have an Account?<Link className='underline' to="/login"> Click here</Link> </p>
               <button className="text-sm mt-6  w-1/2 mx-auto border-b-2  btn btn-primary ">
                    <Link>Sign Up</Link>
               </button>
